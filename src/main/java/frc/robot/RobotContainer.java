...
public class RobotContainer {
  ...
  private final Command climbCommands = new SelectCommand<>(
      Map.ofEntries(
          ...
          Map.entry(CLIMB_STATES.DONE, null)),
      this::climbSelect);
  ...
  private void configureButtonBindings() {
    ...
    // controller
    // .leftBumper()
    // .onTrue(new InstantCommand(() -> shooter.setFlywheelRPMs(600, 600),
    // shooter));
    // controller.leftBumper().onFalse(new InstantCommand(shooter::stopFlywheels,
    // shooter));
