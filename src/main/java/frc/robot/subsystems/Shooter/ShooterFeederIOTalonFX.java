...
public class ShooterFeederIOTalonFX implements ShooterFeederIO {
  ...
  public ShooterFeederIOTalonFX(int id) {
    ...
    config.CurrentLimits.StatorCurrentLimit = Constants.shooterCurrentLimits.feederTalonFXCurrentLimit;
    config.CurrentLimits.StatorCurrentLimitEnable = Constants.shooterCurrentLimits.feederTalonFXCurrentLimitEnabled;
